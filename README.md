# Credit Score Classification - Naive Bayes
...
Credit risk, probabilistic classification and customer analytics. This project was organized as a portfolio-ready case study: it explains the objective, the analytical path, the visual evidence and the practical interpretation behind the result.

Main objective: Classify credit score behavior using Naive Bayes and explain the variables that influence customer risk.

**PT-BR**

Risco de credito, classificacao probabilistica e analise de clientes. Este projeto foi organizado como um estudo de caso pronto para portfolio: explica o objetivo, o caminho analitico, as evidencias visuais e a interpretacao pratica por tras do resultado.

Objetivo principal: Classificar comportamento de score de credito com Naive Bayes e explicar variaveis que influenciam o risco do cliente.
